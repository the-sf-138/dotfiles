...
* elpy
  #+BEGIN_SRC emacs-lisp
    (use-package elpy
      ...
      (setq elpy-rpc-python-command "/data/data/com.termux/files/usr/bin/python3")
       (setq python-shell-interpreter "/data/data/com.termux/files/usr/bin/python3"
